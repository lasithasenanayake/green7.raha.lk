...
<html lang="en">
            ...
            function getCurrentLocation(){
                ...
                if (navigator.geolocation) {
                    var watchId = navigator.geolocation.watchPosition(function(position){
                        ...
                        document.getElementById("idButtonProceed").style.visibility = "visible"; 
                        document.getElementById("idUserMessage").innerHTML = "<strong>Please give permission for the applocation to access geolocation and refresh the browser</strong>, or manually select your location. ";
                        console.log(err);
                        upadteLocationInMap();    
    ...
    <body>
        ...
        <script type="text/javascript" src="//maps.googleapis.com/maps/api/js?key=AIzaSyBL3DJiw5bsubnv67q-mNfect1uHWjRiRE&callback=googlemap_callback"></script>
